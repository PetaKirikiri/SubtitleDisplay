 ...
 * Actual columns: id (bigint), definition_th (text), definition_eng (text), pos_eng (text), pos_th (text), word_th_id (text), source (text), label_eng (text), created_at (timestamp)
 * 
...
export const meaningThSchema = z.object({
  ...
  label_eng: z.string().optional(), // English label
